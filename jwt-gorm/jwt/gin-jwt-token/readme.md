...
[GIN-debug] POST   /apis/v1/register         --> controller.RegisterUser (3 handlers)
[GIN-debug] POST   /apis/v1/login            --> controller.Login (3 handlers)
[GIN-debug] GET    /apis/v1/auth/time        --> controller.GetDataByTime (4 handlers)
